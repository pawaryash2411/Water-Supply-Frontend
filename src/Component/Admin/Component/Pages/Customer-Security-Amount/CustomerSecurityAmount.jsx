...
import {addCustomerSecurity, getAllCustomerSecurity, deleteCustomerSecurity}
...
const CustomerSecurityAmount = () => {
  ...
  console.log(allcustomerSecurityData)
  const filteredCustomerSecurity = allcustomerSecurityData?.filter((customerSecurity) =>
  customerSecurity.customername.toLowerCase().includes(searchTerm.toLowerCase()));
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="text-center"
                      style={{ paddingLeft: "5rem", whiteSpace: "nowrap" }}
                    >
                      Total Deposity
                    </th>
                    <th
                ...
                <tbody>
                  {filteredCustomerSecurity?.length === 0 ? (
                    ...
                    <>
                     {filteredCustomerSecurity?.map((customersecurity, i) => (
                  <tr key={i}>
                    ...
                    <td className="text-center">{customersecurity.balance}</td>
                    <td className="text-center" style={{ paddingLeft: "3rem" }}>
                      <div className="parent_div ">
                        ...
                        >
                          <Link to={`/admin/edit_customer_security_amount/${customersecurity._id}`} style={{textDecoration:"none"}}>
                        ...
                        <div
                          ...
                          aria-label="Example icon button with a menu icon"
                          onClick={() => {
                            HandleOpenModal(customersecurity?._id);
                          }} 
                        >
